		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comtrruntreetable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtrruntreetable-display": {
								"semanticObject": "comtrruntreetable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tr.runtreetable",
									"url": sap.ui.require.toUrl("com/tr/runtreetable")
								}
							}
						}
					}
